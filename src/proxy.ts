...
export const config = {
  matcher: [
    '/((?!login|__nextjs_original-stack-frames|api/auth|api/cli/|api/status/hook|api/health|api/manifest|_next|favicon\\.ico|sw\\.js|fonts|.*\\.(?:svg|png|ico|jpg|jpeg|webp|webmanifest|ttf|woff|woff2)).*)',
  ],
};
