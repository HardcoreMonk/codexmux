...
| [docs/operations/codexwinmux-product-line-migration.md](docs/operations/codexwinmux-product-line-migration.md) | `codexwinmux` 제품 line 분리와 migration 기준 |
| [docs/operations/windows-release-update-repeat-checklist.md](docs/operations/windows-release-update-repeat-checklist.md) | 다음 버전 release/update smoke 반복 기준 |
