...
- **[권한/입력 프롬프트](/codexmux/fr/docs/permission-prompts/)** — 인라인 승인 흐름
- **[세션 상태](/codexmux/fr/docs/session-status/)** — 타임라인 인디케이터를 구동하는 배지들
- **[퀵 프롬프트 & 첨부](/codexmux/fr/docs/quick-prompts-attachments/)** — 하단 입력 바가 할 수 있는 일들
