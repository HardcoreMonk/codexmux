...
- **[테마 & 폰트](/codexmux/fr/docs/themes-fonts/)** — 앱 테마와 폰트 크기
- **[커스텀 CSS](/codexmux/fr/docs/custom-css/)** — 나머지 UI 오버라이드
- **[에디터 연동](/codexmux/fr/docs/editor-integration/)** — 외부 에디터로 파일 열기
