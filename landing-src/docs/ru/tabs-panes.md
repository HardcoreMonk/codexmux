...
서버 재부팅 이후의 복구 동작은 [레이아웃 저장 & 복원](/codexmux/ru/docs/save-restore/)에서 다룹니다.

## 다음으로

- **[레이아웃 저장 & 복원](/codexmux/ru/docs/save-restore/)** — 이 레이아웃이 어떻게 유지되는지
- **[키보드 단축키](/codexmux/ru/docs/keyboard-shortcuts/)** — 전체 바인딩
- **[Git 워크플로 패널](/codexmux/ru/docs/git-workflow/)** — 분할에 띄워두면 유용한 탭 타입
