...
- **[Заметки (AI-дайджест дня)](/purplemux/ru/docs/notes-daily-report/)** — те же данные, оформленные как ежедневный бриф.
- **[Статус сессии](/purplemux/ru/docs/session-status/)** — другое, что боковая панель отслеживает на уровне вкладки.
- **[Клавиатурные сокращения](/purplemux/ru/docs/keyboard-shortcuts/)** — включая <kbd>⌘⇧U</kbd> для статистики.
