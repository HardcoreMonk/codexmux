...
자세한 설정은 [Tailscale 접속](/codexmux/ru/docs/tailscale/), iOS/Android 구체 방법은 [PWA 설정](/codexmux/ru/docs/pwa-setup/)을 참고하세요.

## 다음으로

- **[설치](/codexmux/ru/docs/installation/)** — 플랫폼별 세부 사항, macOS 네이티브 앱, 자동 시작
- **[브라우저 지원](/codexmux/ru/docs/browser-support/)** — 데스크탑/모바일 호환성 매트릭스
- **[첫 세션](/codexmux/ru/docs/first-session/)** — 대시보드 투어
- **[키보드 단축키](/codexmux/ru/docs/keyboard-shortcuts/)** — 전체 바인딩 한눈에
