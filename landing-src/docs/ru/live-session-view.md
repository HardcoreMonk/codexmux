...
- **[Запросы разрешений](/purplemux/ru/docs/permission-prompts/)** — поток одобрения inline.
- **[Статус сессии](/purplemux/ru/docs/session-status/)** — бейджи, которые задают индикаторы таймлайна.
- **[Быстрые промпты и вложения](/purplemux/ru/docs/quick-prompts-attachments/)** — на что способна нижняя строка ввода.
