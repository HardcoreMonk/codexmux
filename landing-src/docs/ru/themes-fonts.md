...
Если хотите тонко настроить отдельные элементы (например, только терминал или только боковую панель), см. [Custom CSS](/purplemux/ru/docs/custom-css/).
...
- **[Custom CSS](/purplemux/ru/docs/custom-css/)** — переопределить отдельные цвета и отступы.
- **[Темы терминала](/purplemux/ru/docs/terminal-themes/)** — отдельная палитра для xterm.js.
