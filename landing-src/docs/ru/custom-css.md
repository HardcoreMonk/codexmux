...
Полный список токенов с дефолтными OKLCH-значениями и обоснованием дизайна — в [`docs/STYLE.md`](https://github.com/subicura/purplemux/blob/main/docs/STYLE.md) репозитория. Этот документ — источник истины.
...
Терминал xterm.js использует свою палитру, выбираемую из подобранного списка, — она не управляется этими CSS-переменными. Переключайте на вкладке **Терминал**. См. [Темы терминала](/purplemux/ru/docs/terminal-themes/).

## Что дальше

- **[Темы и шрифты](/purplemux/ru/docs/themes-fonts/)** — light, dark, system; пресеты размера шрифта.
- **[Темы терминала](/purplemux/ru/docs/terminal-themes/)** — отдельная палитра для области терминала.
- **[Боковая панель и опции Claude](/purplemux/ru/docs/sidebar-options/)** — порядок элементов, флаги Claude.
