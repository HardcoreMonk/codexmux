...
Маленькая шапка каждого дня показывает количество сессий и общую стоимость — те же числа, что использует [дашборд статистики](/purplemux/ru/docs/usage-rate-limits/), в сводном виде.
...
Отчёты пишутся на языке, на который выставлен purplemux. Переключение языка приложения и регенерация даст то же содержимое в новой локали.
{% endcall %}
...
- **[Использование и лимиты](/purplemux/ru/docs/usage-rate-limits/)** — дашборд, откуда берутся эти счётчики сессий и стоимости.
- **[Живой вид сессии](/purplemux/ru/docs/live-session-view/)** — исходные данные в реальном времени.
- **[Клавиатурные сокращения](/purplemux/ru/docs/keyboard-shortcuts/)** — включая <kbd>⌘⇧E</kbd> для Заметок.
