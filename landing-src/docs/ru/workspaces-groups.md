...
Каждое изменение записывается в `~/.purplemux/workspaces.json`. Файл можно посмотреть или забэкапить — полную раскладку файлов смотрите в [Каталоге данных](/purplemux/ru/docs/data-directory/). Если вы удалите его при работающем сервере, purplemux откатится к пустому рабочему пространству и начнёт с чистого листа.

## Что дальше

- **[Вкладки и панели](/purplemux/ru/docs/tabs-panes/)** — разделение, переупорядочивание и фокус внутри рабочего пространства.
- **[Сохранение и восстановление раскладок](/purplemux/ru/docs/save-restore/)** — как рабочие пространства переживают закрытие браузера и перезагрузку сервера.
- **[Клавиатурные сокращения](/purplemux/ru/docs/keyboard-shortcuts/)** — полная таблица биндингов.
