---
title: Статус сессии
description: Как purplemux превращает активность Claude Code в бейдж из четырёх состояний — и почему он обновляется почти мгновенно.
eyebrow: Claude Code
...
- **[Запросы разрешений](/purplemux/ru/docs/permission-prompts/)** — рабочий процесс за состоянием **needs-input**.
- **[Живой вид сессии](/purplemux/ru/docs/live-session-view/)** — что показывает таймлайн, когда вкладка `busy`.
- **[Первая сессия](/purplemux/ru/docs/first-session/)** — экскурсия по панели в контексте.
