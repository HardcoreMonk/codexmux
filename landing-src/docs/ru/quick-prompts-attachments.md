...
- **[Живой вид сессии](/purplemux/ru/docs/live-session-view/)** — где появляются ваши промпты и ответы Claude.
- **[Клавиатурные сокращения](/purplemux/ru/docs/keyboard-shortcuts/)** — полная таблица биндингов.
- **[Запросы разрешений](/purplemux/ru/docs/permission-prompts/)** — что происходит после отправки запроса, требующего одобрения.
