...
- **[라이브 세션 뷰](/codexmux/ru/docs/live-session-view/)** — 프롬프트와 Codex의 답변이 표시되는 곳
- **[키보드 단축키](/codexmux/ru/docs/keyboard-shortcuts/)** — 전체 바인딩 표
- **[권한/입력 프롬프트](/codexmux/ru/docs/permission-prompts/)** — 승인이 필요한 요청을 보낸 뒤 일어나는 일
