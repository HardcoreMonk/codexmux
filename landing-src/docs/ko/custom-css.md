...
xterm.js 터미널은 위 CSS 변수가 아니라 별도의 큐레이션된 팔레트를 씁니다. **터미널** 탭에서 전환하세요. [터미널 테마](/codexmux/ko/docs/terminal-themes/) 참고.

## 다음으로

- **[테마 & 폰트](/codexmux/ko/docs/themes-fonts/)** — 라이트/다크/시스템, 폰트 크기 프리셋
- **[터미널 테마](/codexmux/ko/docs/terminal-themes/)** — 터미널 영역 전용 팔레트
- **[사이드바 & Codex 옵션](/codexmux/ko/docs/sidebar-options/)** — 항목 정렬, Codex 플래그 토글
