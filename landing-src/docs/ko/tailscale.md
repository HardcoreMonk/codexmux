...
- **iOS는 HTTPS 필수** — PWA 설치와 Web Push 모두 HTTPS 없이는 거부됩니다. [PWA 설정](/codexmux/ko/docs/pwa-setup/), [웹 푸시](/codexmux/ko/docs/web-push/) 참고.
...
- 휴대폰에서 URL을 열고 **공유 → 홈 화면에 추가** — [PWA 설정](/codexmux/ko/docs/pwa-setup/) 참고
- Standalone PWA 창 안에서 푸시 활성화 — [웹 푸시](/codexmux/ko/docs/web-push/)
...
- **[PWA 설정](/codexmux/ko/docs/pwa-setup/)** — HTTPS 확보 후 홈 화면에 설치
- **[웹 푸시 알림](/codexmux/ko/docs/web-push/)** — 백그라운드 알림 켜기
- **[보안과 인증](/codexmux/ko/docs/security-auth/)** — 비밀번호, 해싱, 그리고 테일넷 노출이 의미하는 것
