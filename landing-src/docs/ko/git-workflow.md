...
- **[탭 & 창](/codexmux/ko/docs/tabs-panes/)** — Codex 세션 옆에 diff 패널 분할로 띄우기
- **[첫 세션](/codexmux/ko/docs/first-session/)** — 권한/입력 프롬프트가 대시보드에 어떻게 노출되는지
- **[웹 브라우저 패널](/codexmux/ko/docs/web-browser-panel/)** — 터미널 옆에 두면 좋은 또 하나의 패널 타입
