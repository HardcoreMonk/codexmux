...
Capacitor Android 앱도 React UI만 바뀐 경우에는 같은 방식으로 서버 빌드와 재시작만 필요합니다. `android-web/` 런처나 native bridge, Android version metadata가 바뀐 경우에는 APK를 다시 빌드하고 설치해야 합니다.
