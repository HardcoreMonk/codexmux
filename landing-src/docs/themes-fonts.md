...
터미널 palette는 앱 theme와 별도로 관리됩니다. 자세한 내용은 [터미널 테마](/codexmux/docs/terminal-themes/)를 참고하세요.

## 다음 단계

- **[커스텀 CSS](/codexmux/docs/custom-css/)**
- **[터미널 테마](/codexmux/docs/terminal-themes/)**
- **[사이드바 & Codex 옵션](/codexmux/docs/sidebar-options/)**
