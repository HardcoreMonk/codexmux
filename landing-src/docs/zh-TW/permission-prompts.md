---
title: 권한 및 입력 프롬프트
description: Codex의 실행 허가와 입력 선택 질문을 대시보드, 키보드, 휴대폰에서 처리하는 방법.
eyebrow: Codex
permalink: /zh-TW/docs/permission-prompts/index.html
---
{% from "docs/callouts.njk" import callout %}

Codex는 tool call, 파일 쓰기, 권한이 필요한 작업에서 사용자의 승인을 기다릴 수 있습니다. Resume working directory 선택처럼 작업 재개에 필요한 입력을 물을 때도 있습니다. codexmux는 terminal prompt를 감지해 notification panel과 timeline surface에 선택지를 표시합니다.
...
- **[세션 상태](/codexmux/zh-TW/docs/session-status/)**
- **[라이브 세션 뷰](/codexmux/zh-TW/docs/live-session-view/)**
- **[웹 푸시 알림](/codexmux/zh-TW/docs/web-push/)**
