...
각 날짜의 작은 헤더는 세션 수와 총 비용을 보여줍니다 — [통계 대시보드](/codexmux/zh-CN/docs/usage-rate-limits/)와 같은 수치를 요약 형태로.
...
- **[사용량 & 요금 제한](/codexmux/zh-CN/docs/usage-rate-limits/)** — 세션 수와 비용이 오는 대시보드
- **[라이브 세션 뷰](/codexmux/zh-CN/docs/live-session-view/)** — 원본 데이터, 실시간으로
- **[키보드 단축키](/codexmux/zh-CN/docs/keyboard-shortcuts/)** — 노트용 <kbd>⌘⇧E</kbd> 포함
