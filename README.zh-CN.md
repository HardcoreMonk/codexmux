...
- **键盘快捷键** — 分割、切换标签、焦点移动
- **终端主题** — 深色 / 浅色模式,多种配色主题
- **工作区** — 以工作区为单位保存 / 恢复面板布局、标签与工作目录
- **Git Diff 查看器** — 直接在终端面板中查看 git diff。支持 Side-by-side / Line-by-line 切换与语法高亮
- **内置浏览器面板** — 在终端旁嵌入浏览器查看开发结果 (Electron)
...
创建独立的 AI 代理,为其赋予角色与性格 (soul),通过多标签并行执行任务。每个代理拥有独立的聊天、记忆与工作区。
