...
> Codexmux 현재 release: `v0.4.21@3818a28d`
...
Codexmux P0 구현은 production audit 0건, 211 test files 통과와 1개 skip,
...
기능 경로를 최초 통과해 ADR-027과 ADR-028을 `Verified`로 전환했습니다. 현재
[workflow 29162818458](https://github.com/HardcoreMonk/codexmux/actions/runs/29162818458)은
실제 `v0.4.20 -> v0.4.21` updater 적용과 browser/package/published-updater privacy gate까지
재검증했습니다. 상세 증거는 두 Windows release handoff에 보존합니다.
...
검증한 뒤 `v0.4.21`에서 privacy-safe evidence까지 확인했습니다. 다음 우선순위는 rate limit과
