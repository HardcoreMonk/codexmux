...
- `v0.4.20` fresh Windows package/release gate는 packaged upload integrity를 포함해 최초
  통과했고, `v0.4.21`은 실제 `v0.4.20 -> v0.4.21` updater와 privacy gate를 반복했습니다.
- ADR-027과 ADR-028은 `Verified`이며 완료 근거는
  `docs/operations/2026-07-12-v0.4.21-windows-release-handoff.md`에 있습니다.
...
`v0.4.21`은 같은 경로와 privacy-safe evidence를 재검증했으며 이후 stable release도 같은
gate를 반복합니다.
