...
| Electron build/attach/package | 통과 | `corepack pnpm build:electron`, `corepack pnpm smoke:electron:attach`, Mac M1 `pnpm pack:electron:dev`, arm64/x64 DMG/zip 생성, native binding/arch/Info.plist/`hdiutil verify` 통과 |
