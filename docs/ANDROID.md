...
현재 repo/release version은 `0.4.7`이며 2026-05-04 debug install smoke 기준 설치 상태는 `versionName=0.4.7`, `versionCode=407`입니다.
...
현재 `0.4.7` debug install은 `dumpsys package`에서 `versionName=0.4.7`, `versionCode=407`로 보여야 합니다.
