...
Baseline은 현재 version보다 낮은 실제 installer여야 합니다. Synthetic local-feed는 개발용
fallback일 뿐 release acceptance를 충족하지 않습니다.

이 잔여 검증은 [GitHub issue #16](https://github.com/HardcoreMonk/codexmux/issues/16)에서
인수 기준, 실패 시 복구, 완료 뒤 문서 상태 전이까지 추적합니다.
...
- fresh Windows 증거: [GitHub issue #16](https://github.com/HardcoreMonk/codexmux/issues/16), open
- deploy: 수행하지 않음
